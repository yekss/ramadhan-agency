...
<html class="no-js">
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">DAYAT<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/p7.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Awesome Travelling Shots</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="#" target="_blank">Dayat Ramadhan</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Travelling Shots</h2>
					<p>Beberapa hasil moment perjalanan.</p>
				</div>
			</div>
		</div>
		<?php
