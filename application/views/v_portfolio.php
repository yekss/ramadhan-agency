...
<html class="no-js">
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/view8.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Travelling Shots</h2>
		   					<p class="fh5co-lead"> Tangkapan Lensa Kamera <a href="#" target="_blank">Dayat Ramadhan</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
			...
			<a href="#" ><img src="<?php echo base_url().'assets/images/'.$port_image;?>" class="img-responsive"></a>
				<div class="v-align">
					<div class="v-align-middle"><br/>
						...
						<h5 class="category">Travelling</h5>
					</div>
				</div>
		</div>
		<?php endforeach;?>
