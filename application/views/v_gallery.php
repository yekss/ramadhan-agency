...
<html class="no-js">
	...
	<meta name="author" content="Dayat Ramadhan" />
  ...
  <link rel="stylesheet" href="<?php echo base_url().'theme/dist/css/lightbox.css'?>">
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/view4.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Sebuah Gallery</h2>
		   					<p class="fh5co-lead"> Beberapa Photo dari <a href="#" target="_blank">Dayat Ramadhan</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
  ...
  <div class="container">
    <div class="row"><br/>
      <center><h2>Random Shots</h2></center>
