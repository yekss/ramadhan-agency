...
<html class="no-js">
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/view5.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Berminat? Hubungi Saya</h2>
		   					<p class="fh5co-lead">Silahkan Isi Di bawah</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jalan Srikandi,Perumahan Wadya Graha 3 </li>
						<li><i class="icon-phone"></i>+62 853 5609 5499 </li>
						<li><i class="icon-envelope"></i><a href="#">rahmadhidayat1512@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.instagram.com/dayatramadhan_</a></li>
					</ul>
				</div>
